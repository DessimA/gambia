...
public class AnaliseConsumoEntity {
    ...
    public AnaliseConsumoEntity(UUID id, UUID imovelId, BigDecimal consumoKwh, boolean usoHorarioPico,
                                int horasAltoConsumo, String categoria, BigDecimal probabilidade,
                                BigDecimal custoEstimadoMensal, BigDecimal emissaoCo2Kg) {
        this.id = id;
    ...
    public boolean isUsoHorarioPico() { return usoHorarioPico; }
    public int getHorasAltoConsumo() { return horasAltoConsumo; }
    public String getCategoria() { return categoria; }
    public BigDecimal getProbabilidade() { return probabilidade; }
    public BigDecimal getCustoEstimadoMensal() { return custoEstimadoMensal; }
